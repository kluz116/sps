    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         <i class="fa fa-users"></i>  Resa
          </h1>
          <ol class="breadcrumb">
            <li><a href="index"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Resa</li>
          </ol>
        </section>
              ...
              <div class="box">
                ...
                <div class="row">
                	<div class="col-md-11">
                         ...
                         <h3 class="box-title">View All Resas From Here.</h3>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-user"></i> Add New Resa</h4>
                  </div>
                  <div class="modal-body" id="content">
                   <form name="userForm" ng-submit="submitForm(userForm.$valid)" ng-controller="ResaController" novalidate>
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <div class="col-lg-12"><br><br>
                          <input type="text" class="form-control" name="phone" ng-model="phone"  placeholder="Phone Number">
