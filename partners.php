          ...
          <!-- sidebar menu: : style can be found in sidebar.less -->
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="registeredclient.php"><i class="fa fa-angle-right"></i> Clients</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="products.php">
                <i class="fa fa-shopping-cart"></i>
                <span>Accepted And Decline</span>
                <i class="fa fa-angle-right pull-right"></i>
              </a>
            </li>
            <li class="treeview">
              ...
              <div class="box">
                ...
                <div class="row">
                	<div class="col-md-11">
                         ...
                         <h3 class="box-title">View All Partners From Here.</h3>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-user"></i> Add New Partner</h4>
                  </div>
                  <div class="modal-body" id="content">
                   <form name="userForm" ng-submit="submitForm(userForm.$valid)" ng-controller="PartnerController" novalidate>
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <div class="col-lg-6" ng-class="{ 'has-error' : userForm.firstname.$invalid && !userForm.firstname.$pristine }">
                      		<input type="text" class="form-control" name="firstname"  ng-model="firstname" placeholder="Partner Name" required>
                          <p ng-show="userForm.firstname.$invalid && !userForm.firstname.$pristine" class="help-block">Partner Name is required.</p>
                      </div>
                      <div class="col-lg-6" ng-class="{ 'has-error' : userForm.phone.$invalid && !userForm.phone.$pristine }">
                      		<input type="text" class="form-control" name="phone" ng-model="phone"  placeholder="Partner Phone" required>
                          <p ng-show="userForm.phone.$invalid && !userForm.phone.$pristine" class="help-block">Partner Phone is required.</p>
                      </div>
                    </div>
