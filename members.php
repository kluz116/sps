          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="row">
                  <div class="col-md-11">
                      <h3 class="box-title">View All Church Members From Here</h3>
                  </div>
                  <div class="col-md-1">

                    <div class="example-modal">
                      <div class="modal modal-default fade in" id="form-content">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                              <h4 class="modal-title"><i class="fa fa-users"></i> Add Church Member</h4>
                            </div>
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-info btn-sm"><i class="fa fa-save"></i> Save changes</button>
