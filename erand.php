              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-user"></i> Add New Erand Transpoter</h4>
                  </div>
                  <div class="modal-body" id="content">
                   <form name="userForm" ng-submit="submitForm(userForm.$valid)" ng-controller="ErandController" novalidate>
